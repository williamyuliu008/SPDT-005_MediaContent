...
.toc-item { display: grid; grid-template-columns: 2rem auto 1fr; align-items: center; gap: 0.75rem; padding: 0.6rem 0; border-bottom: 1px solid var(--color-border-light); }
.toc-item:last-child { border-bottom: none; }
.toc-item-num { font-family: var(--font-mono); font-size: 0.8rem; color: var(--color-text-muted); text-align: center; }
.toc-item-badge { font-size: 0.8rem; font-weight: 700; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 4px; white-space: nowrap; }
