...
base = r'D:\92_products\SmartTextPlatform\clusters'

template = '''"""CLUSTER — SmartTextPlatform V3 (递进式管道)"""
import sys, os, time
...
for d in ['deepprod', 'flashnews', 'techdoc', 'creativex', 'scipop', 'oped']:
    ep = os.path.join(base, d, 'engine.py')
    open(ep, 'w', encoding='utf-8').write(template)
    print(f'{d}: V3')
