...
【段落格式规范】每段不超过5行（约80-150字），每段2-3句，用句号(。)断句。
请严格遵守以下段落示例：

✅ 正确段落（简洁、有数据来源）：
"据Bloomberg Industry Intelligence预测，2026年中国新能源汽车销量将达约1400万辆，占全球市场份额的60%以上。【A级/机构研报】动力电池系统成本已降至每千瓦时约600元人民币，较2020年下降约40%。【A级/机构研报】"

❌ 错误段落（超长单段、无断句）：
"据Bloomberg Industry Intelligence预测2026年中国新能源汽车销量将达约1400万辆占全球市场份额60%以上同时动力电池系统成本已降至每千瓦时约600元人民币较2020年下降约40%在充电基础设施方面截至2025年底全国充电桩保有量超过1200万台车桩比约为25:1但区域分布不均问题依然存在..."
...
段落规范（严格遵守）：
- 每段不超过5行，约80-150字，2-3句
- 用句号(。)断句，禁止长句连成一团
- 参考上面的"✅ 正确段落"格式，每段必须有来源标注
- 禁止写超长段落（超200字视为严重质量缺陷）
